...
let APBSBotLootCacheService = class APBSBotLootCacheService extends BotLootCacheService_1.BotLootCacheService {
    ...
    apbsLogger;
    apbsLootCache;
    constructor(logger, itemHelper, databaseServer, pmcLootGenerator, localisationService, ragfairPriceService, cloner, apbsEquipmentGetter, apbsTierGetter, raidInformation, apbsLogger) {
        super(logger, itemHelper, databaseServer, pmcLootGenerator, localisationService, ragfairPriceService, cloner);
        this.logger = logger;
...
exports.APBSBotLootCacheService = APBSBotLootCacheService = __decorate([
    ...
    __param(3, (0, tsyringe_1.inject)("PMCLootGenerator")),
    __param(4, (0, tsyringe_1.inject)("LocalisationService")),
    __param(5, (0, tsyringe_1.inject)("RagfairPriceService")),
    __param(6, (0, tsyringe_1.inject)("PrimaryCloner")),
    __param(7, (0, tsyringe_1.inject)("APBSEquipmentGetter")),
    __param(8, (0, tsyringe_1.inject)("APBSTierGetter")),
    __param(9, (0, tsyringe_1.inject)("RaidInformation")),
    __param(10, (0, tsyringe_1.inject)("APBSLogger")),
    __metadata("design:paramtypes", [typeof (_a = typeof ILogger_1.ILogger !== "undefined" && ILogger_1.ILogger) === "function" ? _a : Object, typeof (_b = typeof ItemHelper_1.ItemHelper !== "undefined" && ItemHelper_1.ItemHelper) === "function" ? _b : Object, typeof (_c = typeof DatabaseServer_1.DatabaseServer !== "undefined" && DatabaseServer_1.DatabaseServer) === "function" ? _c : Object, typeof (_d = typeof PMCLootGenerator_1.PMCLootGenerator !== "undefined" && PMCLootGenerator_1.PMCLootGenerator) === "function" ? _d : Object, typeof (_e = typeof LocalisationService_1.LocalisationService !== "undefined" && LocalisationService_1.LocalisationService) === "function" ? _e : Object, typeof (_f = typeof RagfairPriceService_1.RagfairPriceService !== "undefined" && RagfairPriceService_1.RagfairPriceService) === "function" ? _f : Object, typeof (_g = typeof ICloner_1.ICloner !== "undefined" && ICloner_1.ICloner) === "function" ? _g : Object, typeof (_h = typeof APBSEquipmentGetter_1.APBSEquipmentGetter !== "undefined" && APBSEquipmentGetter_1.APBSEquipmentGetter) === "function" ? _h : Object, typeof (_j = typeof APBSTierGetter_1.APBSTierGetter !== "undefined" && APBSTierGetter_1.APBSTierGetter) === "function" ? _j : Object, typeof (_k = typeof RaidInformation_1.RaidInformation !== "undefined" && RaidInformation_1.RaidInformation) === "function" ? _k : Object, typeof (_l = typeof APBSLogger_1.APBSLogger !== "undefined" && APBSLogger_1.APBSLogger) === "function" ? _l : Object])
