...
const setupSpawns = (container) => {
    ...
    constants_1.originalMapList.forEach((map, mapIndex) => {
        ...
        playerSpawns = (0, spawnZoneUtils_1.cleanClosest)(playerSpawns, mapIndex, true);
        scavSpawns = (0, spawnZoneUtils_1.cleanClosest)((0, spawnZoneUtils_1.AddCustomBotSpawnPoints)(scavSpawns, map), mapIndex).map((point, botIndex) => {
        ...
        pmcSpawns = (0, spawnZoneUtils_1.cleanClosest)((0, spawnZoneUtils_1.AddCustomPmcSpawnPoints)(pmcSpawns, map), mapIndex).map((point, pmcIndex) => {
            if (point.ColliderParams?._props?.Radius < limit) {
                point.ColliderParams._props.Radius = limit;
            }
            return !!point.Categories.length
